$(document).ready(function() {
	...
	function getTaiwanWeather(city_name) {
		...
		var Your_Weather_API_key = "CWB-5BCB34BC-5FF4-46B1-B279-430EA5A4F86A";  //IMPORTANT, replace it with your weather API Authkey 中央氣象局授權碼
		//中央氣象局 F-C0032-001 一般天氣預報-今明 36 小時天氣預報資料 API 全部縣市
		var url_all = "https://opendata.cwb.gov.tw/api/v1/rest/datastore/C-B0025-001?Authorization=" + Your_Weather_API_key ;
		...
		.done(function(arr) {
			...
			var time_1 = arr.records.location[0].weatherElement[0].time[0].dateTime;
			var time_2 = arr.records.location[0].weatherElement[0].time[1].dateTime;
			var time_3 = arr.records.location[0].weatherElement[0].time[2].dateTime;
			...
			var weather_1 = arr.records.location[0].weatherElement[0].time[0].elementValue;
			var weather_value_1 = arr.records.location[0].weatherElement[0].time[0].elementValue;
			var weather_value_2 = arr.records.location[0].weatherElement[0].time[1].elementValue;
			var weather_value_3 = arr.records.location[0].weatherElement[0].time[2].elementValue;
